...
public class ChatController {
    ...
    public Message register(@Payload Message message, SimpMessageHeaderAccessor headerAccessor) {
        ...
        headerAccessor.getSessionAttributes().put("userAvatarImage", message.getAvatarImage());
        return chatService.retrieveUserConnectionStatus(message, message.getActionType());
    }
}
